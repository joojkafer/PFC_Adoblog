    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <div class="fadeIn first">
                <img class="loguserimg" src="../images/user_icon_registered.png" id="icon" alt="User Icon" />
            </div>
            <div>
                <b class="fadeIn second"> ONG CADASTRADA COM SUCESSO! </b>
            </div>
            <form action="login.php">
                <input type="submit" style="background-color:#A5EB78;"class="fadeIn third" value="EFETUAR LOGIN">
            </form>
        </div>
    </div>
