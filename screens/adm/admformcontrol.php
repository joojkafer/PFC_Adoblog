    ...
    <div style="min-height: 102vh;">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <a href="../pub/createpost.php" class="btn btn-info mx-2"> Criar Post </a> 
                    <a href="admformcontrol.php?deleteform=<?php echo $row['anm_id']; ?>" class="btn btn-info mx-2" style="width: 102.1px"> Concluir </a>  
                </td>
            </tr>
        <?php endwhile; ?>
        </table>
