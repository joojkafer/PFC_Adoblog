...
if(isset($_POST['update'])){
    ...
    $mysqli->query("UPDATE tb_ong SET ong_nome='$nome', ong_razaosocial='$razaosocial', 
    ong_email='$email', ong_cnpj='$cnpj', ong_estado='$estado', ong_cidade='$cidade', ong_senha='$senha'
